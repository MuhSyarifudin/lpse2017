...
<div class="container">
<p align="center" style="color:#3366CC;">Daftar Paket Lelang Status Lelang Gagal Keseluruhan Tahun <?php echo $_GET['tahun'] ?><br />
</p>
<center><a href="<?php echo base_url().'index.php/report_laporan/gagal?tahun='.$_GET['tahun'] ?>">
