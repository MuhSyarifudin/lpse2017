...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#E4F7FA;box-shadow: 0px 5px 5px #888888;"> 
	...
	<ul class="nav navbar-nav">
        ...
        <li class="active"><a href="<?php echo base_url().'index.php/report/detail'?>"  style="color:white">Tentang Kami</a></li> 
...
<div class="container">
    <div class="breadcrumb" style="background-color: #538DEE;color:white">Tentang Kami</div>
    <div class="panel panel-default">
    <div class="panel-body">
    <table class="">
    <tr><?php if(!empty($detail)){foreach($detail as $r){echo '<td>'.$r['isi'].'</td>';}}?></tr>
    </table>
    </div>
    </div>
</div>
